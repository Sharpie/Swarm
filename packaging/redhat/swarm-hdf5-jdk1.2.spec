%define ver      2.0 
%define rel      1.rh6jdk12 	
%define prefix   /usr

Summary: Toolkit for agent-based modelling.
Name: swarm-with-hdf5
Version: %ver
Release: %rel
Copyright: LGPL
...
JAR=/usr/local/jdk1.2/bin/jar  JAVAC=jikes ./configure --with-defaultdir=/usr --disable-static --prefix=%prefix --with-jdkdir=/usr/local/jdk1.2 
