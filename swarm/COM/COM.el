...
(defun com-impl-print-startup-init-method ()
  ...
  (insert "  static COMEnv env = { createComponent, findComponent, copyString, getName, getComponentName, normalize, selectorQuery, selectorIsJavaScript, selectorIsVoidReturn, selectorIsBooleanReturn, selectorName, selectorArgCount, selectorArgFcallType, selectorCOMInvoke, selectorJSInvoke, COMcreateArgVector, COMsetArg, COMsetReturn, COMfreeArgVector, JScreateArgVector, JSsetArg, JSsetReturn, JSfreeArgVector, COMcollectMethods };\n")
  (insert "  initCOM (&env);\n")
  (insert "  return NS_OK;\n")
  (insert "}\n\n"))
