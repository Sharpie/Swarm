...
externobjcvar BOOL __objc_class_links_resolved;

/* Number of selectors stored in each of the selector  tables */
externobjcvar int __objc_selector_max_index;

/* Mutex locking __objc_selector_max_index and its arrays. */
externobjcvar objc_mutex_t __objc_runtime_mutex;

/* Number of threads which are alive. */
externobjcvar int __objc_runtime_threads_alive;
